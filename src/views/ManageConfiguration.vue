    ...
    <div class="page manageConfiguration">
        <header>
            <div class="contentHeader">
                <div class="mainHeader">Manage Configuration</div>
            ...
            <sui-dropdown fluid multiple :options="searchOption" placeholder="Search by..." selection v-model="searchBy"
                class="left_input" style="height:auto" />
            ...
            <table>
                ...
                <tbody>
                    <tr v-for="(data, index) in responseForTable" :key='index'>
                        ...
                        <td><i class="far fa-edit editHover" style="width:15px;height:15px;cursor:pointer" v-on:click="edit(data.id,data.sysname,data.configurationname,data.value)"></i></td>
